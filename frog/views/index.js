...
router.get('/activityPage', function(req, res, next){
  ...
  activity.getActivity(activityPageValue, 'null', 'null', 'null', 'null', function(datas){    
...
// 수정 필요
router.get('/conditionsActivity/:actClass/:indus/:during/:region', function(req, res, next){
  var search = "A";
  var actClassValue = req.params.actClass;
  var indusValue = req.params.indus;
  var duringValue = req.params.during;
  var regionValue = req.params.region;

  var obj = {
    'actClass': actClassValue,
    'indus': indusValue,
    'during': duringValue,
    'region': regionValue
  }
  ...
  activity.getActivity(conditionsActivityValue, actClassValue, indusValue, duringValue, regionValue, function(datas){    
...
// 별점 높은 순
router.get('/highStarActivity', function(req, res, next){
  activity.getActivity(highStarActivityValue, 'null', 'null', 'null', 'null', function(datas){    
...
// postscript 많은 순
router.get('/highRateActivity', function(req, res, next){
  activity.getActivity(highRateActivityValue, 'null', 'null', 'null', 'null', function(datas){    
...
router.get('/recommandList', function(req, res, next){
  ...
  activity.getActivity(recommandListValue, 'null', 'null', 'null', 'null', function(datas){    
    console.log('datas=', datas);
    res.json(datas);
  });
}); // recommandList
...
router.get('/myPointCheck', function(req, res, next){
    console.log('/index/myPointCheck');
    member.pointCheck(req, function(result){ res.json(result); });
});
...
router.get('/web/detailActivity/:activitySeq', function(req, res, next){
  ...
  activity.webGetActivity(seq, function(result){ res.render('web_detailActivity', result); });
});
...
router.post('/web/updateActivity', function(req, res, next){
  ...
  activity.updateActivity(req, function(result){ res.redirect('/web/detailActivity/'+result); });
});
